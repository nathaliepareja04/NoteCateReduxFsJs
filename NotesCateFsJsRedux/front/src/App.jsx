...
import { deleteNote, getNotes, saveNote, setActivateLink, setFilterNotes, updateNote } from "./redux/NoteSlice";
...
function App() {
  ...
  const { notes, activateLink, filterNotes } = useSelector((state) => state.noteStore);
  ...
  const handleCategory = (category) => {
    category === "All Categories"
      ...
      : dispatch(setFilterNotes(notes.filter((note) => note.category === category)));
          ...
          >
            <div className="card card-body">
              ...
              <div className="icons">
                ...
                <button className="btn" onClick={() => dispatch(deleteNote(item._id))}>
                  <FaTrash />
                </button>
              </div>
            </div>
